...
$config['content']		= array("#<(div|p) class=\"(meldung_wrapper|output_text|kicker_toc|article-content|article_page_intro)[^>]*>(.*)</(div|p)>\s+(<!-- RSPEAK_STOP -->\s+)?(</section>\s+)?<footer#Uis", 1);
